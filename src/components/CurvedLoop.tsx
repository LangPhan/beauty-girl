...
> = ({
  ...
  const textPathRef =
    useRef<SVGTextPathElement | null>(
      null
    );
  const pathRef =
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center w-full absolute inset-0 z-10 pointer-events-none"
      style={{
        visibility: ready
          ? "visible"
          : "hidden",
